...
from .decoder import CoEKSDecoder
from .encoder import CoEKSEncoder


class CoEKSPolicy(AttentionModelPolicy):
...
class CoEKSLightPolicy(CoEKSPolicy):
    def __init__(self, *args, **kwargs):
        ...
        super(CoEKSLightPolicy, self).__init__(*args, **kwargs)
